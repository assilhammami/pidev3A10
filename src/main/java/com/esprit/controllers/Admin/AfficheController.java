    ...
    public void Update() {
        ...
        try {
            for (Travail  ev : TravailList) {
                ...
                fxmlLoader.setLocation(getClass().getResource("/Admin/TravailCard.fxml"));
...
@FXML
    void ajouterEvent(ActionEvent event) throws IOException {
        FXMLLoader loader=new FXMLLoader(getClass().getResource("/Admin/ajouttravail.fxml")); //créer une nouvelle instance de FXMLLoader
