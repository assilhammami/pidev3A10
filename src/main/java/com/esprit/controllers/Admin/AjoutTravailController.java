...
public class AjoutTravailController implements Initializable {
    ...
    void annulerEvent(ActionEvent event) throws IOException {
        FXMLLoader loader=new FXMLLoader(getClass().getResource("/Admin/AfficheTravail.fxml")); //créer une nouvelle instance de FXMLLoader
